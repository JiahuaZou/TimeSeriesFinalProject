...
```{r}
print(CVgeneric(value_log_df1, d = 0, D = 0))
print(CVgeneric(value_log_df1, d = 0))
print(CVgeneric(value_log_df1, d = 0, q = 0))
```
```{r}
print(CVgeneric(value_log))
print(CVgeneric(value_log, d = 0))
...
```
```{r}
model1 <-sarima(value_log,1,0,1,1,1,1,12)
model2 <-sarima(value_log,1,0,1,1,0,1,12)
```
```{r}
print(model1$AIC)
print(model2$AIC)
